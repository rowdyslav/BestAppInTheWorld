...
handlersContext.changeManagersButton.addEventListener('click', changeManagers.bind(handlersContext));
handlersContext.changeCookerButton.addEventListener('click', changeCooker.bind(handlersContext));
